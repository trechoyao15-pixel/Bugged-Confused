...
<main>
  <section class="wrap list-page">
    <header class="list-header">
      <h2>Found Items</h2>
      <p class="muted">Recent found reports — click Claim to submit a claim for an item.</p>
    </header>
    ...
    <div class="table-card">
      ...
      if (!$query || $query->num_rows === 0) {
          echo "<p class='muted'>No found items yet.</p>";
      } else {
          echo "<table class='items-table'>";
          echo "<thead><tr><th>Photo</th><th>Title</th><th>Description</th><th>Date Found</th><th>Location</th><th>Status</th><th>Claim</th></tr></thead>";
          echo "<tbody>";
          ...
          while ($row = $query->fetch_assoc()) {
              ...
              $date = htmlspecialchars($row['date_found']);
              $loc = htmlspecialchars($row['location_found']);
